...
{
	return sName == "gateway" ? this.$getContainer("box") : document.getElementById("box_" + this.uniqueID);
};
...
{
    var sHtml   = '<span class="xul-checkbox' + (this.attributes["disabled"] == "true" ? " xul-checkbox_disabled" : "") + '"><input type="checkbox" id="' + this.uniqueID + '_input" name="' + this.attributes["name"] + '"';
...
{
    var sHtml   = '<span class="xul-radio' + ((this.group && this.group.attributes["disabled"] == "true") || this.attributes["disabled"] == "true" ? " xul-radio_disabled" : "")+ '">';
