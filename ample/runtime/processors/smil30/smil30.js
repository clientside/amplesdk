...
function fAMLSMIL30_getAnimation(oElementDOM) {
	...
	// Simple Animation
	oAnimation.from			= fUtilities_parseCssValue(oElementDOM.getAttribute("from"));
	oAnimation.to			= fUtilities_parseCssValue(oElementDOM.getAttribute("to"));
	oAnimation.by			= fUtilities_parseCssValue(oElementDOM.getAttribute("by"));
...
oAmple.$time	= aAMLSMIL30_elements;

// Registering Event Handlers
fAMLEventTarget_addEventListener(oAmple_document, "load",	fAMLSMIL30_onLoad, false);
fAMLEventTarget_addEventListener(oAmple_document, "unload", fAMLSMIL30_onUnLoad, false);

// register processor
oAMLImplementation_processors[sAMLSMIL30_namespaceURI]	= oAMLSMIL30_implementation;
