...
cChartElement_funnelItem.prototype.$hoverable	= true;

cChartElement_funnelItem.prototype.$getTagOpen	= function() {
	return '<svg:g class="c-funnelItem c-funnelItem_nth-child-' + this.parentNode.childNodes.$indexOf(this) +(this.hasAttribute("class") ? ' ' + this.getAttribute("class") : '')+ '" style="' + this.getAttribute("style") + '" xmlns:svg="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\
