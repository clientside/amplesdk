...
cChartElement_pieItem.prototype.$hoverable	= true;

cChartElement_pieItem.prototype.$getTagOpen	= function() {
	return '<svg:g class="c-pieItem c-pieItem_nth-child-' + this.parentNode.childNodes.$indexOf(this) +(this.hasAttribute("class") ? ' ' + this.getAttribute("class") : '')+ '" style="' + this.getAttribute("style") + '" xmlns:svg="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\
