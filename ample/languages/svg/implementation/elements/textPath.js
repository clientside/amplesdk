...
if (cSVGElement.useVML) {
	...
	cSVGElement_textPath.prototype.$getTagOpen	= function() {
		...
		return '<svg2vml:shape class="svg-textPath' + (this.hasAttribute("class") ? ' ' + this.getAttribute("class") : '')+ '"\
					style="position:absolute;width:100%;height:100%;margin-top:' + nMarginTop + 'px;left:' + (this.parentNode ? this.parentNode.getAttribute("x") : "0") + 'px;top:' + (this.parentNode ? this.parentNode.getAttribute("y") : "0") + 'px;"\
