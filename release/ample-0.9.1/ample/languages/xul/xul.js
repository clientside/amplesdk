...
cXULElement_wizard.goTo	= function(oElement, oPage) {
	...
	oElement.$getContainer("header").className	= "xul-wizardheader xul-wizard--header " + (oPage.attributes["class"] || "");
		...
		var bNext	= cXULElement_wizard.getNextPage(oElement, oPage) != null,			bPrev	= cXULElement_wizard.getPrevPage(oElement, oPage) != null;		oElement.$getContainer("button-back").disabled			= !bPrev;
