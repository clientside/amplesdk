	...
	<xsl:template match="/">
		<html>
			<head>
				<title></title>
				<!-- Prettify -->
				<link type="text/css" href="../../../resources/css/3rdparty/prettify/prettify.css" rel="stylesheet" />
				<script type="text/javascript" src="../../../resources/js/3rdparty/prettify/prettify.js"></script>

				<!--  -->
				<link type="text/css" href="../../../resources/css/content/markup.css" rel="stylesheet" />
				<link type="text/css" href="../../../resources/css/content/object.css" rel="stylesheet" />
				<script type="text/javascript" src="../../../resources/js/content/object.js"></script>
			</head>
			<body>
