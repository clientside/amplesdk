					...
					<tr>\
						<th class="xul-dialog--head" height="1">\
							<table cellpadding="0" cellspacing="0" border="0" width="100%">\
								<tbody>\
									<tr><td class="xul-dialog--title">' +(this.attributes["title"] ? this.attributes["title"] : " ")+ '</td>\
								</tbody>\
							</table>\
						</th>\
					</tr>\
...
cXULElement_treerow.prototype.$getTagOpen	= function()
{
	...
	return '<tr id="' + this.uniqueID + '" class="xul-treerow' + (this.attributes["class"] ? " xul-treerow_" + this.attributes["class"] : '') + '"' + (this.parentNode.parentNode.parentNode.attributes["open"] == "false" ? ' style="display:none"' : '')+ '>' +
